                ...
                <>
                        ...
                        <Form {...form}>
                            ...
                            >
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Vous pouvez modifier toutes les informations du restaurant à
                                        cet endroit.
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="flex-grow">
                                    <div className="grid w-full items-start gap-4 grid-cols-2">
                                        ...
                                        <FieldInput
                                            ...
                                            name="country"
                                            label="Pays"
                                            placeholder="Pays du restaurant"
                                        />
                                        <FieldCheckbox
                                            form={form}
                                            name="languages"
                                ...
                                <CardFooter className="flex justify-end">
                                    <Button type="submit" disabled={isLoadingGeneral}>
                                        Enregistrer
                                    </Button>
                                </CardFooter>
                            </form>
                    ...
                    <Card className="hidden md:flex flex-1 h-fit md:h-full">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Voici une prévisualisation de la présentation de votre
                                entreprise sur le menu en ligne.
                            </CardDescription>
                        </CardHeader>
                            ...
                            <Phone>
                                <div className="text-xs">
                                                        ...
                                                        <CommandGroup>
                                                            {languages?.map((language) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <img
                                                                        src={languagesDisplay(language)?.imageUrl}
                                                                        className="w-3 ml-1"
                                                                    />
                                                                </CommandItem>
                                                            ))}
                                    ...
                                    <div className="flex px-3 py-3 gap-y-2 blur-sm">
                                        <Button className="text-[8px] px-1 h-2" variant="outline">
                                            Tout
                                        </Button>
                                        <Button className="text-[8px] px-1 h-2" variant="outline">
                                            Entrée
                                    ...
                                    <div className="flex flex-col px-3 gap-y-2 blur-sm">
                                        <Card className="overflow-hidden p-0">
                                            <img
                                                src="/assets/images/pates_saumon.png"
                                                alt="imagePlat"
                                            ...
                                            <div className="px-2 py-1">
                                                ...
                                                <p className="text-[8px] leading-3 text-gray-500">
                                                    Des pâtes al dente avec saumon frais et sauce crème
                                                    onctueuse, relevées de fines herbes.
                                                </p>
                                            </div>
                                        </Card>
                                        <Card className="overflow-hidden p-0">
