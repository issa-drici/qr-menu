            ...
            <div className="md:container w-full">
                ...
                <div className="flex flex-col md:flex-row space-y-5 md:space-x-5">
                    <div className="flex flex-col space-y-1">
                        ...
                        <Button variant="ghost" onClick={() => router.push("/admin/account/security")}>Sécurité</Button>
                        <Button variant="white">Gérer mon abonnement</Button>
                    </div>
                    <Card className="w-full">
                        <CardHeader>
                            <CardTitle>Gérer mon abonnement</CardTitle>
                            <CardDescription>
                                Gérez votre abonnement à cet endroit
                            </CardDescription>
                        </CardHeader>
