                        ...
                        <div>
                            ...
                            {showManageSubscriptionButton && (
                                <Link href="/dashboard" legacyBehavior>
                                    <Button className="w-full block justify-center rounded-lg text-center text-sm font-semibold py-3 px-4 mt-8 bg-violet-800 text-white hover:bg-violet-500">Manage Subscription</Button>
                                </Link>
                            )}
                        </div>
                    )}
